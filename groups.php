...
<head>
	<meta charset="utf-8">
	<title>Mail Management Tool groups</title>
			...
			<div class="row-fluid">
				<div class="box span4">
					...
					<div class="box-content">
						<div class="box-content">
							<form action="javascript: addGroup();" method="post">
					...
					<div class="box-content">
						<table class="table table-striped table-bordered" id="displayTable">
							<tr role="row">
								...
								<th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Members" style="width: 96px;">Members</th>
								<th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Date Regisered" style="width: 378px;">Date registered</th>
